...
dlu = datetime.date(2011, 8, 1)
dend = datetime.date(2100, 12, 31)
#print "use `typo3_cas-moleson-ch`;"

while dlu<dend:
	if (dlu.day >= 15 and dlu.day < 22):
		print "INSERT INTO tx_casreservation_dates_special (room_special, date_special,time_special,type_special) VALUES(1,'",dlu,"',",18,",0);"
		print "INSERT INTO tx_casreservation_dates_special (room_special, date_special,time_special,type_special) VALUES(1,'",dlu,"',",20,",0);"
	dlu=dlu+diff2
